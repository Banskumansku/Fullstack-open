...
describe('most liked', () => {
    ...
    test('when list has only one blog equals return that list', () => {
        const result = listHelper.bestBlog(listWithOneBlog)
        expect(result).toEqual(listWithOneBlog[0])
    })

    test('when list has zero blogs equals undefined', () => {
        const result = listHelper.bestBlog([])
        expect(result).toBe(undefined)
    })

    test('when list has multiple blogs, return best blog', () => {
        const result = listHelper.bestBlog(listWithMultipleBlogs)
...
describe('most likes for author', () => {
    ...
    test('when list has multiple authors, return most liked one', () => {
...
describe('most blogs', () => {
    ...
    test('when list has multiple authors, return most liked one', () => {
        const result = listHelper.mostEntries(listWithMultipleBlogs)
